function Footer() {
  ...
  return (
    <footer className=" py-[3rem] flex bg-black  justify-center  items-center tablet:px-4 phoneP:px-2">
      <div className="w-[90%] flex gap-4  justify-between laptop:w-[90%] tablet:w-[100%]  phoneL:flex-col phoneL:gap-6">
